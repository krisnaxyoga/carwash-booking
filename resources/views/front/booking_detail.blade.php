      ...
      <div class="swiper h-fit">
        <div class="swiper-wrapper w-full h-fit">
          <div class="swiper-slide !w-[310px] !h-[350px] flex shrink-0 overflow-hidden">
            <img src="{{asset('assets/images/thumbnails/th-details-1.png')}}" class="object-cover w-full h-full" alt="thumbnail">
          </div>
          <div class="swiper-slide !w-[310px] !h-[350px] flex shrink-0 overflow-hidden">
            <img src="{{asset('assets/images/thumbnails/th-details-2.png')}}" class="object-cover w-full h-full" alt="thumbnail">
          </div>
          <div class="swiper-slide !w-[310px] !h-[350px] flex shrink-0 overflow-hidden">
