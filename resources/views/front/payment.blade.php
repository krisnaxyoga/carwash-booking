...
@section('content')
  <main class="bg-[#FAFAFA] max-w-[640px] mx-auto min-h-screen relative flex flex-col has-[#CTA-nav]:pb-[120px] has-[#Bottom-nav]:pb-[120px]">
    ...
    <div class="flex h-full flex-1 mt-5">
      <form action="{{route('front.booking.payment.store')}}" enctype="multipart/form-data" method="POST" class="w-full flex flex-col rounded-t-[30px] p-5 pt-[30px] gap-[26px] bg-white overflow-x-hidden mb-0 mt-auto">
        @csrf
  ...
  <script src="{{ asset('jssustoms/payment.js') }}"></script>
  @endsection