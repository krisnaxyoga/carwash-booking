...
@section('content')
    ...
    <main
            ...
            <div id="Menus" class="flex flex-col gap-5">
                ...
                <div class="tabs-contents">
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-[10px]">
                                        <div class="w-[60px] h-[60px] flex shrink-0">
                                            <img src="{{ Storage::url($carServices->icon) }}" alt="icon">
                                        </div>
                                        <div class="flex flex-col h-fit">
                                            <p class="font-semibold">{{ $carServices->name }}</p>
                    ...
                    <div id="contact-tab" class="tabcontent flex hidden">
                        <div class="flex flex-col gap-5">
                            <p class="leading-[28px]">Jika Anda memiliki pertanyaan silahkan menghubungi customer service
                                kami</p>
        ...
        <div id="CTA-nav"
            ...
            <div class="flex flex-col gap-[2px]">
                <p class="font-bold text-xl leading-[30px]">Rp {{ number_format($carServices->price, 0, '', '.') }}</p>
                <p class="text-sm leading-[21px] text-[#909DBF]">{{ $carServices->duration_in_hour }} Hours</p>
            </div>
            @if ($carStore->is_open)
                @if ($carStore->is_full)
            ...
            <div class="relative p-4 px-9 w-full max-w-2xl max-h-full">
                ...
                <div class="bg-white max-w-[320px] mx-auto flex flex-col h-fit rounded-[20px] pb-4 gap-4 overflow-hidden">
                    <div class="w-full h-[150px] flex shrink-0">
                        <img src="{{ Storage::url($carServices->photo) }}" class="w-full h-full object-cover"
                            alt="thumbnail">
                    </div>
                    <div class="flex flex-col px-4 gap-4">
                        <div class="flex items-center justify-between">
                            <div class="flex flex-col gap-[2px]">
                                <p class="font-semibold text-lg leading-[27px]">{{ $carServices->name }}</p>
                                <p class="text-sm leading-[21px] text-[#909DBF]">Top Rated Service</p>
                            </div>
                        ...
                        <p class="leading-[28px]">{{ $carServices->about }}</p>
    ...
    <script src="{{ asset('jssustoms/details.js') }}"></script>
@endsection
